...
{
    class StatisticsDisplay : IObserver<WeatherData>
    {
        ...
        {
            this.instName = "Statistics display";
        }
        ...
        {
            Console.WriteLine(this.Name + ": temperature: " + weatherInfo.Temperature + ", humidity: " + weatherInfo.Humidity);
        }
